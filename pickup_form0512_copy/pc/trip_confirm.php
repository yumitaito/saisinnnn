    ...
    <section class="contact_main pb80">
      <div class="contactcontainer">
        ...
        <input type="hidden" name="token" value="<?php echo escape($token); ?>">
          <ul class="inputconfirm_list modaal-content-container">
            <li class="">
              <label class="contact_list_item">
                <span for="name" class="contact_list_ttl">お名前 (カタカナ)</span>
                <input type="hidden" name="name" id="name" value="<?php echo escape($name); ?>" >
                <p><?php echo escape($name); ?></p>
              </label>
            </li>
            </li>
              <label class="contact_list_item">
                  <span class="contact_list_ttl">郵便番号</span>
                  <input type="hidden" name="address" value="<?php echo escape($address); ?>">
                  <p><?php echo escape($address); ?></p>
              </label>
            </li>
            <li class="contact_list_item">
              <label>
                <span class="contact_list_ttl">メールアドレス</span>
                <input type="hidden" name="name" id="email" value="<?php echo escape($email); ?>">
                <p><?php echo escape($email); ?></p>
              </label>
            </li>
            <li class="contact_list_item">
              <label>
                <span class="contact_list_ttl">電話番号</span>
                <input type="hidden" name="tel" id="tel" value="<?php echo escape($tel); ?>">
            ...
            <li class="contact_list_item">
              <label>
                <span class="contact_list_ttl">第1希望</span>
                <input type="hidden" name="date1" id="date1" value="<?php echo escape($date1); ?>">
                <p><?php echo escape($date1); ?></p>
              </label>
            </li>
            <li class="contact_list_item">
              <label>
                <span class="contact_list_ttl">第2希望</span>
                <input type="hidden" name="date2" id="date2" value="<?php echo escape($date2); ?>">
                <p><?php echo escape($date2); ?></p>
              </label>
            </li>
            <li class="contact_list_item">
              <label>
                <span class="contact_list_ttl">第3希望</span>
                <input type="hidden" name="date3" id="date3" value="<?php echo escape($date3); ?>">
                <p><?php echo escape($date3); ?></p>
              </label>
            </li>
            <li class="contact_list_item">
              <label>
                <span class="contact_list_ttl">ご依頼の品目内容</span>
                <input type="hidden" name="content" id="content" value="<?php echo escape($content); ?>">
          ...
          <div class="modal_btnarea">
            ...
            <button type="submit" name="submit" class="modal_submit_btn">上記の内容で送信する</button>
          </div>
        </form>
      </div>
    </section>
