  ...
  <main class="contact_page mb120">
    <section class="contact_main pb80">
      <div class="contactcontainer">
        ...
        <form action="trip_confirm.php" class="validationForm" name="form" method="post" onsubmit="return validate()">
          <div class="contactcontainer">
            <ul class="contact_list">
              <li class="contact_list_item">
                <label>
                  <span class="contact_list_ttl">お名前 (カタカナ)<span class="require_label">必須</span></span>
                  <input class="required maxlength" type="text" name="name" id="name">
                </label>
              </li>
              <li class="contact_list_item">
                <label>
                  <span class="contact_list_ttl">郵便番号<span class="require_label">必須</span></span>
                  <input class="required address" type="text" name="address" id="address">
                </label>
              </li>
              <li class="contact_list_item">
                <label>
              ...
              <li class="contact_list_item">
                ...
                <ul class="contact_list_flex">
                  <li><label><span class="contact_list_ttl">第1希望日</span><input type="date" name="date1" id="date1"></label></li>
                  <li><label><span class="contact_list_ttl">第2希望日</span><input type="date" name="date2" id="date2"></label></li>
                  <li><label><span class="contact_list_ttl">第3希望日</span><input type="date" name="date3" id="date3"></label></li>
                </ul>
              </li>
              <li class="contact_list_item">
                <label>
              ...
              <li class="contact_list_item privacy_list_item">
                ...
                <div class="privacypolicy_check_box">
                  <label class="privacypolicy_check">
                    <input class="required" type="checkbox" name="privacypolicy"><span>個人情報保護方針に同意する</span>
                  </label>
                </div>
              </li>
            </ul>
            <button type="submit" class="def_btn" id="button">ご入力内容の確認</button>
          </div>
        </form>
      </div>
    </section>
